...
async function testDoppusEndpoint() {
  ...
  try {
    console.log('Testando conexão direta com o endpoint /api/webhooks/doppus');
    
    // Usar diretamente o endpoint de webhook sem passar pelo middleware
    const response = await fetch('https://designauto.app/api/webhooks/doppus', {
      method: 'POST',
      headers: {
