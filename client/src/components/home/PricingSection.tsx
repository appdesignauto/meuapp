        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 relative hover:shadow-lg transition-all duration-300">
            <div className="text-center mb-6">
              ...
              <div className="mb-3">
                <span className="text-4xl font-bold text-blue-700">R$47</span>
              </div>
          ...
          <div className="bg-blue-700 rounded-xl p-6 relative text-white hover:shadow-xl transition-all duration-300 transform md:scale-105">
            {/* Best Value Badge */}
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 relative hover:shadow-lg transition-all duration-300">
            ...
            <div className="text-center mb-6 pt-2">
              ...
              <div className="mb-1">
                <span className="text-4xl font-bold text-blue-700">R$36,70</span>
