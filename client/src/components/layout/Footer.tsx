    ...
    <footer className="bg-white border-t border-gray-200">
      <div className="w-full px-4 py-12">
        ...
        <div className="flex flex-col md:flex-row mb-8 items-start max-w-5xl mx-auto">
          ...
          <div className="w-full md:w-64 mb-8 md:mb-0 text-center md:text-left">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-14 w-full md:ml-16 text-left">
            {/* EMPRESA section */}
            <div>
