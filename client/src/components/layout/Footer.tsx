      ...
      <div className="w-full px-4 py-12">
        ...
        <div className="border-t border-gray-200 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-gray-500 text-xs text-center ml-[314px] mr-[314px] mt-[0px] mb-[0px]" style={{ marginLeft: '96px' }}>© DesignAuto 2025 - DESIGNAUTO.COM.BR LTDA - CNPJ 37.561.761/0001-0</div>
