    ...
    <>
      ...
      <div className="bg-white min-h-screen">
        ...
        <div className="container mx-auto py-8">
          ...
          {/* Barra de pesquisa exclusiva para videoaulas */}
          <div className="px-4 md:px-8 my-4">
            <div className="relative max-w-md mx-auto">
              <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 h-5 w-5" />
              <Input
                type="text"
                placeholder="Buscar aulas e tutoriais..."
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
                ref={searchInputRef}
                className="pl-10 pr-10 py-6 h-auto border-gray-200 bg-white rounded-full shadow-sm focus:border-blue-500 focus:ring-blue-500 text-base"
              />
              {searchTerm && (
                <button
