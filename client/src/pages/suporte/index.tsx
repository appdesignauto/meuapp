      ...
      <div className="container mx-auto py-10 px-4 md:px-6">
        <div className="max-w-5xl mx-auto">
              ...
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                <Card className="border-blue-100 hover:shadow-md transition-shadow">
                  ...
                  <CardContent>
                    ...
                    <Badge variant="outline" className="mt-2">Tempo de resposta: 1-2h</Badge>
                  </CardContent>
                  <CardFooter>
                    <Button 
                ...
                <Card className="border-blue-100 hover:shadow-md transition-shadow">
                  <CardHeader className="pb-3">
                    ...
                    <CardDescription>Suporte por e-mail para dúvidas detalhadas</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <p className="text-sm">
                      Envie suas dúvidas para nosso e-mail e nossa equipe responderá em breve.
                    </p>
                    <Badge variant="outline" className="mt-2">Tempo de resposta: 24-48h</Badge>
                  </CardContent>
                  <CardFooter>
                    <Button 
                      variant="outline" 
                ...
                <Card className="border-blue-100 hover:shadow-md transition-shadow">
                  <CardHeader className="pb-3">
                    ...
                    <CardDescription>Grupo de usuários no WhatsApp</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <p className="text-sm">
                      Participe do nosso grupo e conecte-se com outros usuários do Design Auto.
                    </p>
                    <Badge variant="outline" className="mt-2">+500 participantes</Badge>
                  </CardContent>
                  <CardFooter>
                    <Button 
                      variant="secondary" 
                  ...
                  <CardContent className="space-y-6">
                    <div className="space-y-2">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold">Como faço para editar uma arte?</h3>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start gap-3">
                        <CircleHelp className="h-5 w-5 text-blue-500 flex-shrink-0 mt-0.5" />
                        <div>
                          <h3 className="font-semibold">Como faço para renovar minha assinatura?</h3>
                          <p className="text-sm text-muted-foreground">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start gap-3">
                        <CircleHelp className="h-5 w-5 text-blue-500 flex-shrink-0 mt-0.5" />
                        <div>
                          <h3 className="font-semibold">Como posso contribuir com artes para a comunidade?</h3>
                          <p className="text-sm text-muted-foreground">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start gap-3">
                        <CircleHelp className="h-5 w-5 text-blue-500 flex-shrink-0 mt-0.5" />
                        <div>
                          <h3 className="font-semibold">Como funcionam os pontos D.Auto?</h3>
                          <p className="text-sm text-muted-foreground">
          ...
          <div className="mt-16 mb-10">
            <h2 className="text-2xl font-bold text-center mb-8">Nosso Compromisso com Você</h2>
