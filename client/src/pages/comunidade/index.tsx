          ...
          <div>
            ...
            <p className="text-xs text-zinc-500 dark:text-zinc-400 flex items-center gap-1">
              <svg
                ...
                fill="currentColor"
              >
                <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0ZM1.612 8.972c-.088-.297-.154-.61-.194-.927h2.14c.03.434.103.847.212 1.241l.039.105H1.612Zm1.574-3.347H2.14a6.155 6.155 0 0 1 .194-.927h2.196a7.543 7.543 0 0 0-.25 1.346l-.001.016H3.186c0-.145.003-.29.008-.435h-.008Zm.97 4.588H2.496A6.107 6.107 0 0 0 3.1 11.31l.085.134h2.02a7.878 7.878 0 0 1-.556-1.23Zm1.91-1.241h-2.58a8.826 8.826 0 0 1-.188-1.241h2.973a8.592 8.592 0 0 1-.204 1.241Zm2.681-1.241H5.772c.025-.433.076-.845.152-1.241h4.05a10.028 10.028 0 0 1-.327 1.241Zm-3.045 3.505a5.612 5.612 0 0 0 2.473 0A8.97 8.97 0 0 1 8 13.33a8.97 8.97 0 0 1-2.225-1.078Zm-.464-1.023a6.705 6.705 0 0 0 3.401 0c.156-.443.281-.907.367-1.385l.6.002H5.838a9.219 9.219 0 0 0 .374 1.383ZM8 1.166c.811 0 1.58.184 2.269.512A10.244 10.244 0 0 0 8 4.084a10.244 10.244 0 0 0-2.269-2.406A6.813 6.813 0 0 1 8 1.166ZM4.299 2.102a9.041 9.041 0 0 1 2.6 2.3 11.123 11.123 0 0 1-2.056-.246 9.256 9.256 0 0 1-.544-2.054ZM4.174 5.388c.758.171 1.54.269 2.332.29l.064.001a10.694 10.694 0 0 0-.181 1.241H3.5a10.416 10.416 0 0 1 .03-.326 5.607 5.607 0 0 1 .644-1.206Zm-1.764 2.6h3.007c-.026.434-.083.85-.17 1.241H3.394a6.158 6.158 0 0 1-.984-1.241Zm8.854-6.035a6.153 6.153 0 0 1 .74 1.407 6.05 6.05 0 0 1 .245 1.085 10.238 10.238 0 0 1-2.058.246 9.04 9.04 0 0 1 1.073-2.738ZM9.76 5.388a8.994 8.994 0 0 0 2.94-1.235c.153.398.27.808.349 1.228l.006.007H10.02a10.694 10.694 0 0 0-.259-1.308l.018.044h-.018v.264Zm3.45 2.6a6.155 6.155 0 0 1-.194.927H10.82a9.035 9.035 0 0 0 .17-1.241h2.219v.314Zm-1.23 2.02c.185.32.404.612.652.87a6.217 6.217 0 0 1-1.156.824c.176-.516.328-1.069.454-1.649l.05-.044Z" />
              </svg>
