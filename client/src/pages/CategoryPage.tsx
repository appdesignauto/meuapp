                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2 mt-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs sm:text-sm text-gray-600 truncate">
                      Atualizada em: {category.updatedAt ? formatDate(category.updatedAt.toString()) : 'Data não disponível'}
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs sm:text-sm text-gray-600 truncate">
                      Adicionada: {category.createdAt ? format(parseISO(category.createdAt.toString()), 'PP', { locale: ptBR }) : 'Data não disponível'}
                    </span>
                  </div>
                </div>
              </div>
